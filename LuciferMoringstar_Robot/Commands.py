...
from Config import START_MSG, CHANNELS, ADMINS, AUTH_CHANNEL, CUSTOM_FILE_CAPTION, TUTORIAL, BROADCAST_CHANNEL, DB_URL, SESSION, ADMIN_ID, BOT_USERNAME, START_TXT, PICS
    ...
    if usr_cmdall1.startswith("/start pr0fess0r_99"):
        if AUTH_CHANNEL:
            ...
            try:
                ...
                await bot.send_message(
                    chat_id=message.from_user.id,
                    text="**⭕ നിങ്ങൾ ചോദിച്ച സിനിമ വേണം എന്നുണ്ടെങ്കിൽ ആദ്യം JOIN GROUP അടിച്ചു ജോയിൻ ചെയ്യുക എന്നിട്ട് DOWNLOAD എന്ന ഭാഗം CLICK ചെയ്യുക സിനിമ ലഭിക്കും ⭕️**",
